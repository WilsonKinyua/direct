        ...
        <div class="page-content">
            <div class="page-bar">
                <div class="page-title-breadcrumb">
                    <div class=" pull-left">
                        <div class="page-title">Edit Showroom</div>
                    </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="card-box">
                        ...
                        <form action="{{ route('admin.showrooms.update', [$showroom->id]) }}" method="POST"
                            ...
                            <div class="card-body row">
                                <div class="col-lg-6 p-t-20">
                                    <div
                                        ...
                                        <input class="mdl-textfield__input" type="text" id="txtCourseName" name="name"
                                            required value="{{ old('name', $showroom->name) }}">
                                ...
                                <div class="col-lg-6 p-t-20">
                                    <div
                                        ...
                                        <input class="mdl-textfield__input" type="text" id="txtCourseCode" name="location"
                                            required value="{{ old('location', $showroom->location) }}">
                                ...
                                <div class="col-lg-12 p-t-20">
                                    <div
                                        class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
                                        <input class="mdl-textfield__input" type="url" id="txtCourseCode" name="map_link" value="{{ old('map_link', $showroom->map_link) }}">
                                ...
                                <div class="col-lg-6 p-t-20">
                                    <div
                                        ...
                                        <input class="mdl-textfield__input" type="tel" id="txtCourseCode"
                                            name="phone_number" required value="{{ old('phone_number', $showroom->phone_number) }}">
                                ...
                                <div class="col-lg-6 p-t-20">
                                    <div
                                        ...
                                        <input class="mdl-textfield__input" type="email" id="txtCourseCode" name="email"
                                            required value="{{ old('email', $showroom->email) }}">
                                ...
                                <div class="col-lg-12 p-t-20">
                                    <div
                                        class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
                                        <input class="mdl-textfield__input" type="url" id="txtCourseCode" name="web_url" value="{{ old('web_url', $showroom->web_url) }}">
                                ...
                                <div class="col-lg-6 p-t-20">
                                    <div
                                        ...
                                        <input class="mdl-textfield__input" type="text" id="txtCourseCode" name="admin_name"
                                            required value="{{ old('admin_name', $showroom->admin_name) }}">
                                ...
                                <div class="col-lg-6 p-t-20">
                                    <div
                                        ...
                                        <input class="mdl-textfield__input" type="email" id="txtCourseCode"
                                            name="admin_email" required value="{{ old('admin_email', $showroom->admin_email) }}">
